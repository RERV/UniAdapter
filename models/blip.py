...
def create_vit(vit, image_size, use_grad_checkpointing=False, ckpt_layer=0, drop_path_rate=0, config=None, adapters=None):
    ...
    if vit=='base':
        ...
        visual_encoder = VisionTransformer(config=config, img_size=image_size, patch_size=16, embed_dim=vision_width, depth=12, 
                                           ...
                                           drop_path_rate=0 or drop_path_rate, adapters=adapters
                                          )   
    elif vit=='large':
        vision_width = 1024
        visual_encoder = VisionTransformer(config=config, img_size=image_size, patch_size=16, embed_dim=vision_width, depth=24, 
                                           ...
                                           drop_path_rate=0.1 or drop_path_rate, adapters=adapters
                                          )   
...
# create_vit('base', 224, use_grad_checkpointing=False, ckpt_layer=0, drop_path_rate=0, config=None)